...
public enum ErrorCode {
    ...
    NO_SUCH_BOOK_FOUND("Book(s) with the passed ISBN was not found in the system", HttpStatus.NOT_FOUND),
    ...
    UPDATE_REQUIRES_PROPER_ID("Update book requires a proper id", HttpStatus.BAD_REQUEST),
